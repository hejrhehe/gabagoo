...
do -- Example UI
	local Window = library:AddWindow("ArsaHax", {
		main_color = Color3.fromRGB(41, 74, 122),
...
game.ReplicatedStorage.wkspc.DistributedTime.Value);
    ...
    Tab:AddButton("Silent Aim", function()
        loadstring(game:HttpGet'https://ic3w0lf.xyz/rblx/arsenal_silent_aim')();
    end
		...
		Tab:AddKeybind("Kill All (Keybinded)", function(key)
		...
		Console:Set("game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 69")
		print(Console:Get())
